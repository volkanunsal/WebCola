!(function () {
  ...
  function At() {
    var n = Ct(),
      t = Nt() - n;
    t > 24
      ? (isFinite(t) && (clearTimeout($a), ($a = setTimeout(At, t))), (Xa = 0))
      : ((Xa = 1), Wa(At));
  }
  function Ct() {
    var n = Date.now();
  ...
  function Du(n, t) {
    ...
    return (
      ...
      f != h
        ? u.push({ i: r.push(r.pop() + "skewX(", null, ")") - 2, x: lu(f, h) })
    ...
    if ((e = n.children) && (s = e.length)) {
      ...
      if (
        ...
        for (
          ...
          p
            ? (d > v || (v == d && u.r < r.r) ? hi(r, (u = a)) : hi((r = c), u),
              o--)
            : (fi(r, i), (u = i), t(i));
        }
      var m = (l + f) / 2,
  ...
  function ro(n) {
    ...
    return (
      ...
      (t.interpolate = function (n) {
        return arguments.length
          ? ((o = "function" == typeof n ? (i = n) : (i = xs.get(n) || uo).key),
            t)
          : o;
      }),
  ...
  function Eo(n) {
    ...
    return (
      ...
      (t.interpolate = function (n) {
        return arguments.length
          ? ((c = "function" == typeof n ? (a = n) : (a = xs.get(n) || uo).key),
            (s = a.reverse || a),
            (l = a.closed ? "M" : "L"),
            t)
          : c;
  ...
  (Zo.interpolateZoom = function (n, t) {
    ...
    (Zo.behavior.zoom = function () {
      ...
      function f() {
        ...
        d
          ? clearTimeout(d)
          : ((g = t((p = v || Zo.mouse(this)))), H.call(this), o(n)),
          (d = setTimeout(function () {
            (d = null), c(n);
          }, 50)),
          y(),
          r(Math.pow(2, 0.002 * Ta()) * S.k),
          u(p, g),
          a(n);
      }
      function h() {
  ...
  (Zo.geo.path = function () {
    ...
    (Zo.geo.rotation = function (n) {
      ...
      return (
        ...
        (t.invert = function (t) {
          return (
            (t = n.invert(t[0] * Aa, t[1] * Aa)), (t[0] *= Ca), (t[1] *= Ca), t
          );
        }),
        t
      );
  ...
  (Zo.geom.delaunay = function (n) {
    ...
    (Zo.geom.quadtree = function (n, t, e, r, u) {
      ...
      return (o = arguments.length)
        ? ((a = uu), (c = iu), 3 === o && ((u = e), (r = t), (e = t = 0)), i(n))
        : ((i.x = function (n) {
    ...
    function n(i) {
      i.each(function () {
        ...
        var l,
          f = Zo.transition(i),
          h = Zo.transition(o);
        c && ((l = Ti(c)), h.attr("x", l[0]).attr("width", l[1] - l[0]), e(f)),
          s &&
            ((l = Ti(s)), h.attr("y", l[0]).attr("height", l[1] - l[0]), r(f)),
          t(f);
      });
    }
    function t(n) {
  ...
  (Os.year = Qa.year.utc),
    ...
    "function" == typeof define && define.amd
      ? define(Zo)
      : "object" == typeof module && module.exports && (module.exports = Zo),
    (this.d3 = Zo);
})();
