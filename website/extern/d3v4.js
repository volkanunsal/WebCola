...
(function (global, factory) {
  ...
  var histogram = function () {
    ...
    histogram.value = function (_) {
      return arguments.length
        ? ((value = typeof _ === "function" ? _ : constant$1(_)), histogram)
        : value;
    };

    histogram.domain = function (_) {
      return arguments.length
        ? ((domain = typeof _ === "function" ? _ : constant$1([_[0], _[1]])),
          histogram)
        : domain;
    };
      ...
      // Otherwise, draw an arc!
        ...
        var x20 = x2 - x0,
          ...
          l =
            r *
            Math.tan(
              (pi$1 - Math.acos((l21_2 + l01_2 - l20_2) / (2 * l21 * l01))) / 2
            ),
          t01 = l / l01,
          t21 = l / l21;
  ...
  var arc = function () {
    ...
    arc.innerRadius = function (_) {
      return arguments.length
        ? ((innerRadius = typeof _ === "function" ? _ : constant$2(+_)), arc)
        : innerRadius;
    };

    arc.outerRadius = function (_) {
      return arguments.length
        ? ((outerRadius = typeof _ === "function" ? _ : constant$2(+_)), arc)
        : outerRadius;
    };

    arc.cornerRadius = function (_) {
      return arguments.length
        ? ((cornerRadius = typeof _ === "function" ? _ : constant$2(+_)), arc)
        : cornerRadius;
    };
    ...
    arc.padRadius = function (_) {
      return arguments.length
        ? ((padRadius =
            _ == null ? null : typeof _ === "function" ? _ : constant$2(+_)),
          arc)
        : padRadius;
    };
    ...
    arc.startAngle = function (_) {
      return arguments.length
        ? ((startAngle = typeof _ === "function" ? _ : constant$2(+_)), arc)
        : startAngle;
    };

    arc.endAngle = function (_) {
      return arguments.length
        ? ((endAngle = typeof _ === "function" ? _ : constant$2(+_)), arc)
        : endAngle;
    };

    arc.padAngle = function (_) {
      return arguments.length
        ? ((padAngle = typeof _ === "function" ? _ : constant$2(+_)), arc)
        : padAngle;
    };
  ...
  var line = function () {
    ...
    line.x = function (_) {
      return arguments.length
        ? ((x$$1 = typeof _ === "function" ? _ : constant$2(+_)), line)
        : x$$1;
    };

    line.y = function (_) {
      return arguments.length
        ? ((y$$1 = typeof _ === "function" ? _ : constant$2(+_)), line)
        : y$$1;
    };
  ...
  var area$1 = function () {
    ...
    area.x = function (_) {
      return arguments.length
        ? ((x0 = typeof _ === "function" ? _ : constant$2(+_)),
          (x1 = null),
          area)
        : x0;
    };
    ...
    area.y = function (_) {
      return arguments.length
        ? ((y0 = typeof _ === "function" ? _ : constant$2(+_)),
          (y1 = null),
          area)
        : y0;
    };
  ...
  var pie = function () {
    ...
    pie.value = function (_) {
      return arguments.length
        ? ((value = typeof _ === "function" ? _ : constant$2(+_)), pie)
        : value;
    };
    ...
    pie.startAngle = function (_) {
      return arguments.length
        ? ((startAngle = typeof _ === "function" ? _ : constant$2(+_)), pie)
        : startAngle;
    };

    pie.endAngle = function (_) {
      return arguments.length
        ? ((endAngle = typeof _ === "function" ? _ : constant$2(+_)), pie)
        : endAngle;
    };

    pie.padAngle = function (_) {
      return arguments.length
        ? ((padAngle = typeof _ === "function" ? _ : constant$2(+_)), pie)
        : padAngle;
    };
  ...
  var symbol = function () {
    ...
    symbol.type = function (_) {
      return arguments.length
        ? ((type = typeof _ === "function" ? _ : constant$2(_)), symbol)
        : type;
    };

    symbol.size = function (_) {
      return arguments.length
        ? ((size = typeof _ === "function" ? _ : constant$2(+_)), symbol)
        : size;
    };
  ...
  var stack = function () {
    ...
    stack.keys = function (_) {
      return arguments.length
        ? ((keys = typeof _ === "function" ? _ : constant$2(slice$2.call(_))),
          stack)
        : keys;
    };
    ...
    stack.value = function (_) {
      return arguments.length
        ? ((value = typeof _ === "function" ? _ : constant$2(+_)), stack)
        : value;
    };
  ...
  function hue(a, b) {
    var d = b - a;
    return d
      ? linear$1(a, d > 180 || d < -180 ? d - 360 * Math.round(d / 360) : d)
    ...
    on: function (typename, callback) {
      ...
      while (++i < n) {
        if ((t = (typename = T[i]).type))
          ...
          for (t in _) _[t] = set$2(_[t], typename.name, null);
      }
  ...
  function continuous(deinterpolate, reinterpolate) {
    ...
    function rescale() {
      piecewise =
        Math.min(domain.length, range$$1.length) > 2 ? polymap : bimap;
      output = input = null;
      return scale;
    }
    ...
    scale.domain = function (_) {
      return arguments.length
        ? ((domain = map$3.call(_, number$1)), rescale())
        : domain.slice();
    };

    scale.range = function (_) {
      return arguments.length
        ? ((range$$1 = slice$3.call(_)), rescale())
        : range$$1.slice();
    };
  ...
  function identity$4() {
    ...
    scale.domain = scale.range = function (_) {
      return arguments.length
        ? ((domain = map$3.call(_, number$1)), scale)
        : domain.slice();
    };
  ...
  function quantize$1() {
    ...
    scale.range = function (_) {
      return arguments.length
        ? ((n = (range$$1 = slice$3.call(_)).length - 1), rescale())
        : range$$1.slice();
    };
  ...
  var transition_select = function (select$$1) {
    ...
    for (
      ...
      for (
        ...
        if (
          (node = group[i]) &&
          (subnode = select$$1.call(node, node.__data__, i, group))
        ) {
          if ("__data__" in node) subnode.__data__ = node.__data__;
          subgroup[i] = subnode;
  ...
  function styleRemove$1(name, interpolate$$1) {
    ...
    return function () {
      var style = window(this).getComputedStyle(this, null),
        ...
        value1 =
          (this.style.removeProperty(name), style.getPropertyValue(name));
      return value0 === value1
        ? null
        : value0 === value00 && value1 === value10
        ? interpolate0
  ...
  var index = function () {
    ...
    pack.padding = function (x) {
      return arguments.length
        ? ((padding = typeof x === "function" ? x : constant$6(+x)), pack)
        : padding;
    };
  ...
  var index$1 = function () {
    ...
    treemap.paddingInner = function (x) {
      return arguments.length
        ? ((paddingInner = typeof x === "function" ? x : constant$6(+x)),
          treemap)
        : paddingInner;
    };
    ...
    treemap.paddingTop = function (x) {
      return arguments.length
        ? ((paddingTop = typeof x === "function" ? x : constant$6(+x)), treemap)
        : paddingTop;
    };

    treemap.paddingRight = function (x) {
      return arguments.length
        ? ((paddingRight = typeof x === "function" ? x : constant$6(+x)),
          treemap)
        : paddingRight;
    };
    ...
    treemap.paddingBottom = function (x) {
      return arguments.length
        ? ((paddingBottom = typeof x === "function" ? x : constant$6(+x)),
          treemap)
        : paddingBottom;
    };
    ...
    treemap.paddingLeft = function (x) {
      return arguments.length
        ? ((paddingLeft = typeof x === "function" ? x : constant$6(+x)),
          treemap)
        : paddingLeft;
    };
  ...
  var drag = function () {
    ...
    drag.filter = function (_) {
      return arguments.length
        ? ((filter = typeof _ === "function" ? _ : constant$8(!!_)), drag)
        : filter;
    };

    drag.container = function (_) {
      return arguments.length
        ? ((container = typeof _ === "function" ? _ : constant$8(_)), drag)
        : container;
    };

    drag.subject = function (_) {
      return arguments.length
        ? ((subject = typeof _ === "function" ? _ : constant$8(_)), drag)
        : subject;
    };
  ...
  function RedBlackNode(node) {
    node.U = node.C = node.L = node.R = node.P = node.N = null; // parent node // color - true for red, false for black // left node // right node // previous node // next node
  }
            ...
            halfedges.splice(
              ...
              edges.push(
                createBorderEdge(
                  ...
                  Math.abs(endX - x0) < epsilon$3 && y1 - endY > epsilon$3
                    ? [x0, Math.abs(startX - x0) < epsilon$3 ? startY : y1]
                    : Math.abs(endY - y1) < epsilon$3 && x1 - endX > epsilon$3
                    ? [Math.abs(startY - y1) < epsilon$3 ? startX : x1, y1]
                    : Math.abs(endX - x1) < epsilon$3 && endY - y0 > epsilon$3
                    ? [x1, Math.abs(startX - x1) < epsilon$3 ? startY : y0]
                    : Math.abs(endY - y0) < epsilon$3 && endX - x0 > epsilon$3
                    ? [Math.abs(startY - y0) < epsilon$3 ? startX : x0, y0]
                    : null
                )
              ) - 1
            );
  ...
  var voronoi = function () {
    ...
    function voronoi(data) {
      return new Diagram(
        data.map(function (d, i) {
          var s = [
            Math.round(x$$1(d, i, data) / epsilon$3) * epsilon$3,
            Math.round(y$$1(d, i, data) / epsilon$3) * epsilon$3,
          ];
          s.index = i;
          s.data = d;
          return s;
    ...
    voronoi.x = function (_) {
      return arguments.length
        ? ((x$$1 = typeof _ === "function" ? _ : constant$9(+_)), voronoi)
        : x$$1;
    };

    voronoi.y = function (_) {
      return arguments.length
        ? ((y$$1 = typeof _ === "function" ? _ : constant$9(+_)), voronoi)
        : y$$1;
    };
  ...
  var zoom = function () {
        ...
        k = Math.max(
          ...
          Math.min(
            ...
            t.k *
              Math.pow(
                2,
                (-exports.event.deltaY * (exports.event.deltaMode ? 120 : 1)) /
                  500
              )
          )
        ),
    ...
    zoom.filter = function (_) {
      return arguments.length
        ? ((filter = typeof _ === "function" ? _ : constant$10(!!_)), zoom)
        : filter;
    };
  ...
  function brush$1(dim) {
    ...
    brush.move = function (group, selection$$1) {
      if (group.selection) {
          ...
          .tween("brush", function () {
            var that = this,
              ...
              selection1 = dim.input(
                typeof selection$$1 === "function"
                  ? selection$$1.apply(this, arguments)
                  : selection$$1,
                state.extent
              ),
        ...
        group.each(function () {
          ...
          interrupt(that);
          state.selection =
            selection1 == null || empty$1(selection1) ? null : selection1;
          redraw.call(that);
        ...
        group
          ...
          .attr("width", function (d) {
            return d.type === "n" || d.type === "s"
              ? selection$$1[1][0] - selection$$1[0][0] + handleSize
              : handleSize;
          })
          .attr("height", function (d) {
            return d.type === "e" || d.type === "w"
              ? selection$$1[1][1] - selection$$1[0][1] + handleSize
              : handleSize;
          });
      } else {
        group
    ...
    Emitter.prototype = {
      ...
      emit: function (type) {
        customEvent(
          new BrushEvent(brush, type, dim.output(this.state.selection)),
          listeners.apply,
          listeners,
          [type, this.that, this.args]
        );
    ...
    function started() {
      ...
      var that = this,
        ...
        mode =
          (exports.event.metaKey ? (type = "overlay") : type) === "selection"
            ? MODE_DRAG
    ...
    brush.filter = function (_) {
      return arguments.length
        ? ((filter = typeof _ === "function" ? _ : constant$11(!!_)), brush)
        : filter;
    };
  ...
  var ribbon = function () {
    ...
    ribbon.radius = function (_) {
      return arguments.length
        ? ((radius = typeof _ === "function" ? _ : constant$12(+_)), ribbon)
        : radius;
    };

    ribbon.startAngle = function (_) {
      return arguments.length
        ? ((startAngle = typeof _ === "function" ? _ : constant$12(+_)), ribbon)
        : startAngle;
    };

    ribbon.endAngle = function (_) {
      return arguments.length
        ? ((endAngle = typeof _ === "function" ? _ : constant$12(+_)), ribbon)
        : endAngle;
    };
  ...
  var circle$1 = function () {
    ...
    circle.center = function (_) {
      return arguments.length
        ? ((center = typeof _ === "function" ? _ : constant$13([+_[0], +_[1]])),
          circle)
        : center;
    };
    ...
    circle.radius = function (_) {
      return arguments.length
        ? ((radius = typeof _ === "function" ? _ : constant$13(+_)), circle)
        : radius;
    };

    circle.precision = function (_) {
      return arguments.length
        ? ((precision = typeof _ === "function" ? _ : constant$13(+_)), circle)
        : precision;
    };
    ...
    return (clip = {
      stream: function (stream) {
        return cache && cacheStream === stream
          ? cache
          : (cache = clipExtent(x0, y0, x1, y1)((cacheStream = stream)));
      },
      extent: function (_) {
        return arguments.length
          ? ((x0 = +_[0][0]),
    ...
    function intersect(a, b, two) {
      ...
      if (
        meridian
          ? polar
            ? (phi0 + phi1 > 0) ^
              (q[1] < (abs(q[0] - lambda0) < epsilon$4 ? phi0 : phi1))
            : phi0 <= q[1] && q[1] <= phi1
    ...
    function resampleLineTo(
      ...
      if (d2 > 4 * delta2 && depth--) {
        var a = a0 + a1,
          ...
          phi2 = asin$1((c /= m)),
          lambda2 =
            abs(abs(c) - 1) < epsilon$4 || abs(lambda0 - lambda1) < epsilon$4
              ? (lambda0 + lambda1) / 2
              : atan2(b, a),
    ...
    projection.stream = function (stream) {
      return cache && cacheStream === stream
        ...
        : (cache = transformRadians(
            preclip(rotate, projectResample(postclip((cacheStream = stream))))
          ));
    };
  ...
  var identity$8 = function () {
    var k = 1,
      ...
      sx = 1,
      sy = 1,
      transform = identity$7, // scale, translate and reflect
      x0 = null,
      y0,
      x1,
      y1,
      clip = identity$7, // clip extent
      cache,
      cacheStream,
      projection;
    ...
    return (projection = {
      stream: function (stream) {
        return cache && cacheStream === stream
          ? cache
          : (cache = transform(clip((cacheStream = stream))));
      },
      ...
      scale: function (_) {
        return arguments.length
          ? ((transform = scaleTranslate((k = +_) * sx, k * sy, tx, ty)),
            reset())
          : k;
      },
