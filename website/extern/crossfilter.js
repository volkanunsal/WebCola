(function (exports) {
  ...
  var heapselect = (crossfilter.heapselect = heapselect_by(
  ...
  var insertionsort = (crossfilter.insertionsort = insertionsort_by(
    crossfilter_identity
  ));
  ...
  function quicksort_by(f) {
    ...
    function sort(a, lo, hi) {
      return (hi - lo < quicksort_sizeThreshold ? insertionsort : quicksort)(
        a,
        lo,
        hi
      );
    ...
    function quicksort(a, lo, hi) {
      ...
      var pivotsEqual =
        pivotValue1 <= pivotValue2 && pivotValue1 >= pivotValue2;
      if (pivotsEqual) {
      ...
      if (less < i1 && great > i5) {
        ...
        while (
          (lessValue = f(a[less])) <= pivotValue1 &&
          lessValue >= pivotValue1
        )
          ++less;
        while (
          (greatValue = f(a[great])) <= pivotValue2 &&
          greatValue >= pivotValue2
        )
          --great;
  ...
  function crossfilter() {
    ...
    function dimension(value) {
      ...
      function filterExact(value) {
        return filterIndexBounds(
          (refilter = crossfilter_filterExact(bisect, value))(values)
        );
      }
      ...
      function filterRange(range) {
        return filterIndexBounds(
          (refilter = crossfilter_filterRange(bisect, range))(values)
        );
      }
      ...
      function group(key) {
        ...
        function add(newValues, newIndex, n0, n1) {
          ...
          groupIndex =
            k0 > 1
              ? crossfilter_arrayLengthen(groupIndex, n)
        ...
        function removeData() {
          if (k > 1) {
            ...
            (groups = []), (k = 0);
            filterListeners[
              filterListeners.indexOf(update)
        ...
        function reduceSum(value) {
          return reduce(
            crossfilter_reduceAdd(value),
            crossfilter_reduceSubtract(value),
            crossfilter_zero
          );
        }
